  ...
  (
    ...
    const handleToggle = React.useCallback(
      (optValue: string) => {
        ...
        // Keep dropdown open for multi-select, but refocus input
        inputRef.current?.focus();
      },
      [value, onChange]
    );
    ...
    return (
      ...
      >
        ...
        <button
          ...
          disabled={disabled}
          className={cn(
            "flex items-center justify-between w-full min-h-9 px-3 py-1.5 rounded-md border border-input bg-background text-sm transition-colors",
            disabled
